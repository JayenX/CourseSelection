...
public interface SpecialityMapper {
    ...
    @Select("select speciality.*, college.name as collegeName from speciality left join college on speciality.college_id = college.id where speciality.name like concat('%', #{name}, '%')")
