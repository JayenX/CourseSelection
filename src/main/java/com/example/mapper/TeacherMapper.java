...
public interface TeacherMapper {
    ...
    @Select("select teacher.*, speciality.name as specialityName from teacher left join speciality on teacher.speciality_id = speciality.id where teacher.name like concat('%', #{name}, '%')")
