<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="Please enter the name of the speciality to search"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="Affiliated college" prop="collegeName"></el-table-column>
    ...
    <el-dialog title="Speciality information" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
