<template>
  <div>
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="Please enter the teacher's name to search"></el-input>
    ...
    <div class="card">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="Speciality" prop="specialityName" class-name="no-break-word"></el-table-column>
    ...
    <el-dialog title="Teacher information" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="Title" prop="title">
          <el-select v-model="data.form.title" placeholder="Please select a title" style="width: 100%">
        ...
        <el-form-item label="Speciality" prop="specialityId">
          <el-select v-model="data.form.specialityId" placeholder="Please select a speciality">
            <el-option
